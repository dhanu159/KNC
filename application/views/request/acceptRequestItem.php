...
<div class="content-wrapper arcadia-main-container">
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-body">
                <form role="form" class="add-form" method="post" action="<?= base_url('request/AcceptAllRequestItems/' . $request_header_data['intRequestHeaderID']) ?>" id="acceptAllRequestItems">
                            ...
                            <tbody>
                                ...
                                foreach ($request_detail_data as $k => $v) { ?>
                                    <tr>
                                        ...
                                        <td class="static">
                                            <?php
                                            if ($v['IsAccepted'] == 0 && ($v['IsApproved'] == 1) && $v['IsCancelled'] == 0) {
                                                $buttonVisible = true;
                                            ?>
                        ...
                        <div class="row" style="border-top:1px solid #dee2e6;">
                            ...
                            ?>
                                 <button type="button" id="btnAddtAllItems" class="btn btn-lg btn-info btn-flat float-right col-6" style="display: inline-block;"><i class="fas fa-calendar-check"></i>&nbsp;&nbsp;&nbsp;Accept All</button>
                             <?php }
                             ?>
                            </div>
                            <!-- /.col -->
...
<script src="<?php echo base_url('resources/pageJS/acceptRequestItem.js') ?>"></script>