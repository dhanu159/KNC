                ...
                <form role="form" class="add-form" method="post" action="<?= base_url('Utilities/EditCuttingOrderDetails/' . $cuttingorder_header_data['intCuttingOrderHeaderID']) ?>" id="editCuttingOrder">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="edit_order_name" name="edit_order_name" autocomplete="off" required value="<?= $cuttingorder_header_data['vcOrderName']; ?>">
                        </div>
                        ...
                        <tbody>
                            ...
                            foreach ($cuttingorder_detail_data as $k => $v) { ?>
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control itemName disable-typing" name="description[]" id="description_<?= $row ?>" value="<?= $v['vcSizeDescription'] ?>" readonly></td>
                    ...
                    <div class="row" style="border-top:1px solid #dee2e6;">
                        ...
                        <div class="col-6" style="padding-right:100px;">
                            <button type="button" id="btnEditSubmit" class="btn btn-lg btn-info btn-flat float-right"><i class="fas fa-calendar-check"></i>&nbsp;&nbsp;&nbsp;Submit</button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
