            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Cutting Order Configuration</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <?php if ($this->session->userdata('Is_main_branch') == true) { ?>
                    <?php if (in_array('createRequestItem', $user_permission) || $isAdmin) { ?>
                        <a href="<?= base_url("Utilities/CreateCuttingOrderConfiguration") ?>" class="btn btn-info btn-flat"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Create Cutting Order Configuration</a>
...
<script src="<?php echo base_url('resources/pageJS/viewCuttingOrderConfiguration.js') ?>"></script>