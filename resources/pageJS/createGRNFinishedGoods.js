$(document).ready(function () {
    ...
    function AddToGrid() {
        ...
        if ($("#cmbItem option:selected").val() == 0 || $("input[name=txtQty]").val() == "") {
            ...
            if ($("#cmbItem option:selected").val() > 0) {
                ...
                $("input[name=cmbItem], input[name=txtMeasureUnit],input[name=txtQty]").val("");
    ...
    $('#btnSubmit').click(function () {
        ...
        // if (jQuery.trim($("#dispatch_no").val()).length == 0) {
        //     toastr["error"]("Please enter dispatch no !");
        //     $("#dispatch_no").focus();
        // } else 
        if (isNaN(Date.parse($("#receivedDate").val()))) {
            ...
            arcadiaConfirmAlert("You want to be able to save this !", function (button) {
                ...
                var form = $("#createGRNFinishedGoods");
    ...
    $("#createGRNFinishedGoods").unbind('submit').on('submit', function (e) {
